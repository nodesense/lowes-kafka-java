...
public class PageViewStats extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -299446611989295404L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"PageViewStats\",\"namespace\":\"ai.nodesense.models\",\"fields\":[{\"name\":\"user\",\"type\":\"string\"},{\"name\":\"page\",\"type\":\"string\"},{\"name\":\"industry\",\"type\":\"string\"},{\"name\":\"count\",\"type\":\"long\"}]}");
   ...
   */
  public PageViewStats(java.lang.CharSequence user, java.lang.CharSequence page, java.lang.CharSequence industry, java.lang.Long count) {
    this.user = user;
    this.page = page;
   ...
   */
  public static ai.nodesense.models.PageViewStats.Builder newBuilder() {
    return new ai.nodesense.models.PageViewStats.Builder();
  }
   ...
   * @return A new PageViewStats RecordBuilder
   */
  public static ai.nodesense.models.PageViewStats.Builder newBuilder(ai.nodesense.models.PageViewStats.Builder other) {
    return new ai.nodesense.models.PageViewStats.Builder(other);
  }
   ...
   * @return A new PageViewStats RecordBuilder
   */
  public static ai.nodesense.models.PageViewStats.Builder newBuilder(ai.nodesense.models.PageViewStats other) {
    return new ai.nodesense.models.PageViewStats.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PageViewStats>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(ai.nodesense.models.PageViewStats.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(ai.nodesense.models.PageViewStats other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.user)) {
        this.user = data().deepCopy(fields()[0].schema(), other.user);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public ai.nodesense.models.PageViewStats.Builder setUser(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ai.nodesense.models.PageViewStats.Builder clearUser() {
      user = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public ai.nodesense.models.PageViewStats.Builder setPage(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ai.nodesense.models.PageViewStats.Builder clearPage() {
      page = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public ai.nodesense.models.PageViewStats.Builder setIndustry(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ai.nodesense.models.PageViewStats.Builder clearIndustry() {
      industry = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public ai.nodesense.models.PageViewStats.Builder setCount(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ai.nodesense.models.PageViewStats.Builder clearCount() {
