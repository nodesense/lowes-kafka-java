...
public class UserProfile extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -449451294488711267L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"UserProfile\",\"namespace\":\"ai.nodesense.models\",\"fields\":[{\"name\":\"experience\",\"type\":[\"string\",\"null\"]},{\"name\":\"region\",\"type\":\"string\"}]}");
   ...
   */
  public static ai.nodesense.models.UserProfile.Builder newBuilder() {
    return new ai.nodesense.models.UserProfile.Builder();
  }
   ...
   * @return A new UserProfile RecordBuilder
   */
  public static ai.nodesense.models.UserProfile.Builder newBuilder(ai.nodesense.models.UserProfile.Builder other) {
    return new ai.nodesense.models.UserProfile.Builder(other);
  }
   ...
   * @return A new UserProfile RecordBuilder
   */
  public static ai.nodesense.models.UserProfile.Builder newBuilder(ai.nodesense.models.UserProfile other) {
    return new ai.nodesense.models.UserProfile.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<UserProfile>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(ai.nodesense.models.UserProfile.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(ai.nodesense.models.UserProfile other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.experience)) {
        this.experience = data().deepCopy(fields()[0].schema(), other.experience);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public ai.nodesense.models.UserProfile.Builder setExperience(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ai.nodesense.models.UserProfile.Builder clearExperience() {
      experience = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public ai.nodesense.models.UserProfile.Builder setRegion(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ai.nodesense.models.UserProfile.Builder clearRegion() {
      region = null;
