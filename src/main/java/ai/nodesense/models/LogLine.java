...
public class LogLine extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 594638838749844028L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"LogLine\",\"namespace\":\"ai.nodesense.models\",\"fields\":[{\"name\":\"ip\",\"type\":\"string\"},{\"name\":\"timestamp\",\"type\":\"long\"},{\"name\":\"url\",\"type\":\"string\"},{\"name\":\"referrer\",\"type\":\"string\"},{\"name\":\"useragent\",\"type\":\"string\"},{\"name\":\"sessionid\",\"type\":[\"null\",\"int\"],\"default\":null}]}");
  public static org.apache.avro.Schema getClassSchema() { return SCHEMA$; }

  private static SpecificData MODEL$ = new SpecificData();

  private static final BinaryMessageEncoder<LogLine> ENCODER =
      new BinaryMessageEncoder<LogLine>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<LogLine> DECODER =
      new BinaryMessageDecoder<LogLine>(MODEL$, SCHEMA$);

  /**
   * Return the BinaryMessageDecoder instance used by this class.
   */
  public static BinaryMessageDecoder<LogLine> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<LogLine> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<LogLine>(MODEL$, SCHEMA$, resolver);
  }

  /** Serializes this LogLine to a ByteBuffer. */
  public java.nio.ByteBuffer toByteBuffer() throws java.io.IOException {
    return ENCODER.encode(this);
  }

  /** Deserializes a LogLine from a ByteBuffer. */
  public static LogLine fromByteBuffer(
   ...
   * @return A new LogLine RecordBuilder
   */
  public static ai.nodesense.models.LogLine.Builder newBuilder() {
    return new ai.nodesense.models.LogLine.Builder();
  }
   ...
   * @return A new LogLine RecordBuilder
   */
  public static ai.nodesense.models.LogLine.Builder newBuilder(ai.nodesense.models.LogLine.Builder other) {
    return new ai.nodesense.models.LogLine.Builder(other);
  }
   ...
   * @return A new LogLine RecordBuilder
   */
  public static ai.nodesense.models.LogLine.Builder newBuilder(ai.nodesense.models.LogLine other) {
    return new ai.nodesense.models.LogLine.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<LogLine>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(ai.nodesense.models.LogLine.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(ai.nodesense.models.LogLine other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.ip)) {
        this.ip = data().deepCopy(fields()[0].schema(), other.ip);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public ai.nodesense.models.LogLine.Builder setIp(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ai.nodesense.models.LogLine.Builder clearIp() {
      ip = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public ai.nodesense.models.LogLine.Builder setTimestamp(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ai.nodesense.models.LogLine.Builder clearTimestamp() {
    ...
    /**
      ...
      * @return This builder.
      */
    public ai.nodesense.models.LogLine.Builder setUrl(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ai.nodesense.models.LogLine.Builder clearUrl() {
      url = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public ai.nodesense.models.LogLine.Builder setReferrer(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ai.nodesense.models.LogLine.Builder clearReferrer() {
      referrer = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public ai.nodesense.models.LogLine.Builder setUseragent(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ai.nodesense.models.LogLine.Builder clearUseragent() {
      useragent = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public ai.nodesense.models.LogLine.Builder setSessionid(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ai.nodesense.models.LogLine.Builder clearSessionid() {
      sessionid = null;
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<LogLine>
    WRITER$ = (org.apache.avro.io.DatumWriter<LogLine>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<LogLine>
    READER$ = (org.apache.avro.io.DatumReader<LogLine>)MODEL$.createDatumReader(SCHEMA$);
