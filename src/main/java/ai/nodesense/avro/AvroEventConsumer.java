...
public class AvroEventConsumer {
    ...
    public static void main(String[] args) throws ExecutionException, InterruptedException {
        ...
        AvroEventConsumer sessionizer = new AvroEventConsumer(brokers, groupId, inputTopic, outputTopic, url);
        sessionizer.run();
    ...
    public AvroEventConsumer(String brokers, String groupId, String inputTopic, String outputTopic, String url) {
